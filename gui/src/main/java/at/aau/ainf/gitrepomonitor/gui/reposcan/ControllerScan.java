...
public class ControllerScan extends StatusBarController implements Initializable, PropertyChangeListener {
    ...
    private void setupUI() {
        ...
        listFoundRepos.setCellFactory(new RepositoryInformationListCellFactory(this, progessMonitor, false));
        ...
        listWatchlist.setCellFactory(new RepositoryInformationListCellFactory(this, progessMonitor, true));
